...
public class ChangeLanguageJapanese implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(MenuComponent.CLOSE_POPPUP_BUTTON),
                ...
                Click.on(LanguagePage.BTN_JAPANESE));

    }

    public static ChangeLanguageJapanese changeLanguageJapanese () {
        return Tasks.instrumented(ChangeLanguageJapanese.class);
    }
