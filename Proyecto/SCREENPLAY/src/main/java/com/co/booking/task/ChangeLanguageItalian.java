...
public class ChangeLanguageItalian implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(MenuComponent.CLOSE_POPPUP_BUTTON),
                ...
                Click.on(LanguagePage.BTN_ITALIANO));

    }

    public static ChangeLanguageItalian changeLanguageItalian () {
        return Tasks.instrumented(ChangeLanguageItalian.class);
    }
