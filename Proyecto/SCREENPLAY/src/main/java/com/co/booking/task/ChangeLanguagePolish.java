...
public class ChangeLanguagePolish implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(MenuComponent.CLOSE_POPPUP_BUTTON),
                ...
                Click.on(LanguagePage.BTN_POLISH));

    }

    public static ChangeLanguagePolish changeLanguagePolish () {
        return Tasks.instrumented(ChangeLanguagePolish.class);
    }
