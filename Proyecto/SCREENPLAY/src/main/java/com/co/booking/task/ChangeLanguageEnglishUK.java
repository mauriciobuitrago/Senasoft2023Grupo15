...
public class ChangeLanguageEnglishUK implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(MenuComponent.CLOSE_POPPUP_BUTTON),
                ...
                Click.on(LanguagePage.BTN_ENGLISH_UK));

    }

    public static ChangeLanguageEnglishUK changeEnglishUK () {
        return Tasks.instrumented(ChangeLanguageEnglishUK.class);
    }
