...
public class ChangeLanguageFilipino implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(MenuComponent.CLOSE_POPPUP_BUTTON),
                ...
                Click.on(LanguagePage.BTN_FILIPINO));

    }

    public static ChangeLanguageFilipino changeLanguageFilipino () {
        return Tasks.instrumented(ChangeLanguageFilipino.class);
    }
