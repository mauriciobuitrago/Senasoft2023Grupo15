...
public class RegisterEmptyPaswords implements Task {
    ...
    public static RegisterEmptyPaswords enterCredentials() {
        return Tasks.instrumented(RegisterEmptyPaswords.class);
    }
}
