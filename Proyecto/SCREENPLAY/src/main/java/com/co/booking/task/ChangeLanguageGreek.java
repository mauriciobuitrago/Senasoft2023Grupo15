...
public class ChangeLanguageGreek implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(MenuComponent.CLOSE_POPPUP_BUTTON),
                ...
                Click.on(LanguagePage.BTN_GREEK));

    }

    public static ChangeLanguageGreek changeLanguageGreek () {
        return Tasks.instrumented(ChangeLanguageGreek.class);
    }
