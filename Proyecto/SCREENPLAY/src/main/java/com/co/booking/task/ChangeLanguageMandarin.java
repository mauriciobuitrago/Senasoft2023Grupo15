...
public class ChangeLanguageMandarin implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(MenuComponent.CLOSE_POPPUP_BUTTON),
                ...
                Click.on(LanguagePage.BTN_MANDARIN));

    }

    public static ChangeLanguageMandarin changeLanguageMandarin () {
        return Tasks.instrumented(ChangeLanguageMandarin.class);
    }
