...
public class ChangeLanguagePortuguesePT implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(MenuComponent.CLOSE_POPPUP_BUTTON),
                ...
                Click.on(LanguagePage.BTN_PortuguespPT));

    }

    public static ChangeLanguagePortuguesePT changeLanguagePortuguesePT () {
        return Tasks.instrumented(ChangeLanguagePortuguesePT.class);
    }
