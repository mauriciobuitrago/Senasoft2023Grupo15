...
public class ChangeLanguagePortuguese implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(MenuComponent.CLOSE_POPPUP_BUTTON),
                ...
                Click.on(LanguagePage.BTN_PORTUGUESBR));

    }

    public static ChangeLanguagePortuguese changeLanguagePortuguese () {
        return Tasks.instrumented(ChangeLanguagePortuguese.class);
    }
