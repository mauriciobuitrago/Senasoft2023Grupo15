...
public class RegisterEmptyFirtsPasword implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(MenuComponent.CLOSE_POPPUP_BUTTON),
                ...
                Enter.theValue("").into(RegisterPage.TXT_FIRST_PASSWORD),
                Enter.theValue("Prueba123456").into(RegisterPage.TXT_SECOND_PASSWORD),
                Click.on(RegisterPage.BTN_CREATE_ACCOUNT));
    }

    public static RegisterEmptyFirtsPasword enterCredentials() {
        return Tasks.instrumented(RegisterEmptyFirtsPasword.class);
    }
}
